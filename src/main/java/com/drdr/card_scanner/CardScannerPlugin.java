...
public class CardScannerPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware, PluginRegistry.ActivityResultListener {
    ...
    public final static String METHOD_CHANNEL_NAME = "drdr/card_scanner";
    ...
    void showCameraActivity(MethodCall call) {
        ...
        Intent intent = new Intent(context, CardDetectionActivity.class);
        intent.putExtra(CardDetectionActivity.CARD_SCAN_OPTIONS, cardScannerOptions);
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == SCAN_REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                if (data != null && data.hasExtra(CardDetectionActivity.SCAN_RESULT)) {
                    CardDetails cardDetails = data.getParcelableExtra(CardDetectionActivity.SCAN_RESULT);
